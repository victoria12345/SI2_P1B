...
import ssii2.visa.*;
// import ssii2.visa.dao.VisaDAO; ESTE CREO QUE YA NO SE PONE PORQUE PONEMOS VISADAOWS.
...
private void printAddresses(HttpServletRequest request, HttpServletResponse response) throws SocketException {
   ...
   /**
    * Procesa una peticion HTTP tanto GET como POST.
